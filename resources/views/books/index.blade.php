                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="m-0">{{number_format($book->copiesNumber)}} copies
                                                    available</p>
                                            ...
                                            <div>
                                                <a href="{{route('books.show', ['chosenBook'=> $book->id])}}"
                                                   class="btn btn-primary w-100 mt-3">Go
                                                    To Book Page</a>
                                            </div>
                                            <div class="d-flex justify-content-around mt-3">
                                                <a href="{{route('books.edit', ['editedBook'=> $book->id])}}"
                                                   class="btn btn-info">Update</a>
                                                <form action="{{route('books.destroy', ['books' => $book->id])}}"
                                                      method="POST">
                                                    {{ csrf_field() }}
