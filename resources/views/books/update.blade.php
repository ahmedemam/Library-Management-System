  ...
  <section>
    <form action="{{route('books.update', [$editedBook->id])}}" method=POST>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <input type="text" name="updatedDescription" value="{{$editedBook->description}}" class="form-control" />
        </div>
      </div>
      {{-- author --}}
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <input type="number" min="0" name="updatedCopiesNumber" value="{{number_format($editedBook->copiesNumber)}}" class="form-control" />
        </div>
      </div>
      {{-- lease fee --}}
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <input type="number" min="0" name="updatedLeaseFee" value="{{$editedBook->leaseFee}}" class="form-control" />
        </div>
      </div>
      {{-- submit --}}
